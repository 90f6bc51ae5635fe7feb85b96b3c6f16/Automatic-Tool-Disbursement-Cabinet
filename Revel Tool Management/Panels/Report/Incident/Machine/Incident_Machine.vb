...
Public Class Incident_Machine
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        Dim dt As DataTable = config.GetDataTable("SELECT incident_id, jobs_name, jobs_op_name, machines_name, shift, " &
                                                 ...
                                                 " AND tb_incident.products_id = tb_products.products_id " & str & " GROUP BY incident_id ORDER BY machines_name, incident_time")
        ...
        ElseIf cbChartType.SelectedItem = "Pie" Then
            ...
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.Incident_Machine_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.Incident_Machine_Line.rdlc"
        End If
