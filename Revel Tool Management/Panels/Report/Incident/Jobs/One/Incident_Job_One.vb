    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        If lvJobs.SelectedItems.Count > 0 Then
            For i As Integer = 0 To lvJobs.Items.Count - 1
                If lvJobs.Items(i).Selected Then
                    str2 &= " AND tb_incident.jobs_id ='" & dt_main.Rows(i).Item("jobs_id") & "'"
                    Exit For
                End If
            Next
        ...
        ElseIf cbChartType.SelectedItem = "Pie" Then
            ...
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.Incident_Job_One_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.Incident_Job_One_Line.rdlc"
        End If
