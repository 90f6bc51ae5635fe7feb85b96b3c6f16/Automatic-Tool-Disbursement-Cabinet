...
Public Class rp_analysis_product_cost
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        dt_main = config.GetDataTable("SELECT 'stock-' | tb_products.products_id as stock_log_id ,  products_code, SUM( stock_qty * stock_price) as cost " &
                                      "FROM tb_stock_log " &
        ...
        Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_analysis_product_cost.rdlc"
