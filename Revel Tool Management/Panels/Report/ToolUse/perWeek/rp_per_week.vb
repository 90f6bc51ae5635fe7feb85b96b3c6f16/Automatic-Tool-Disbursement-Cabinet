...
Public Class rp_per_week
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        ElseIf cbChartType.SelectedItem = "Pie" Then
            ...
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_per_week_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_per_week_Line.rdlc"
        End If
