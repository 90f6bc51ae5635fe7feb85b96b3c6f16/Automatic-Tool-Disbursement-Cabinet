...
Public Class rp_stock_machines
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        dt_main = config.GetDataTable("SELECT  machines_name , SUM( stock_qty * stock_price) as cost " &
                                      "FROM tb_stock_log " &
                                      ...
                                      "AND tb_stock_log.machines_id IN (" & str_in & ") " &
                                      str_group & str &
                                      "GROUP BY  machines_name " &
                                      "ORDER BY  machines_name DESC ")
        ...
        ElseIf cbChartType.SelectedItem = "Pie" Then
            ...
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_stock_machines_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_stock_machines_Line.rdlc"
        End If
    ...
    Private Sub rp_stock_machines_Load(sender As Object, e As EventArgs) Handles MyBase.Load
