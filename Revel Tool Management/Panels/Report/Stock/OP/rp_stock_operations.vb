...
Public Class rp_stock_operations
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        dt_main = config.GetDataTable("SELECT tb_stock_log.jobs_id, tb_stock_log.jobs_op_id,  jobs_name,  jobs_op_name , SUM( stock_qty * stock_price) as cost " &
                                      "FROM tb_stock_log " &
                                      ...
                                      str_group & str &
                                      "GROUP BY  tb_stock_log.jobs_id, tb_stock_log.jobs_op_id " &
                                      "ORDER BY  tb_stock_log.jobs_id, tb_stock_log.jobs_op_id DESC ")

        If cbChartType.SelectedItem = "Candle" Then
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_stock_operations.rdlc"
        ElseIf cbChartType.SelectedItem = "Pie" Then

            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_stock_operations_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_stock_operations_Line.rdlc"
        End If
    ...
    Private Sub rp_stock_operations_Load(sender As Object, e As EventArgs) Handles MyBase.Load
