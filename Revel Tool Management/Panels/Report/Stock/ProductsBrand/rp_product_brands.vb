...
Public Class rp_product_brands
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        For Each Item In lbProductBrand.SelectedItems
        ...
        dt_main = config.GetDataTable("SELECT tb_products_brand.products_brand_id ,  products_brand_name, SUM( stock_qty * stock_price) as cost " &
                                      "FROM tb_stock_log " &
                                      ...
                                      "AND tb_products_brand.products_brand_id IN (" & str_in & ") " & str &
                                      "GROUP BY  tb_products_brand.products_brand_id  " &
                                      "ORDER BY  tb_products_brand.products_brand_id  DESC ")

        If cbChartType.SelectedItem = "Candle" Then
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_brands.rdlc"
        ElseIf cbChartType.SelectedItem = "Pie" Then

            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_brands_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_brands_Line.rdlc"
        End If
    ...
    Private Sub cmdSelectAll_Click(sender As Object, e As EventArgs) Handles cmdSelectAll.Click
        For i As Int32 = 0 To lbProductBrand.Items.Count - 1
            lbProductBrand.SetSelected(i, True)
        Next
    End Sub

    Private Sub cmdUnselect_Click(sender As Object, e As EventArgs) Handles cmdUnselect.Click
        For i As Int32 = 0 To lbProductBrand.Items.Count - 1
            lbProductBrand.SetSelected(i, False)
        Next
    End Sub
    ...
    Sub getProductBrand()
        ...
        Dim dt As DataTable = config.GetDataTable(
            "SELECT products_brand_id, products_brand_name FROM tb_products_brand "
        )


        lbProductBrand.DataSource = dt
        lbProductBrand.DisplayMember = "products_brand_name"
        lbProductBrand.ValueMember = "products_brand_id"
