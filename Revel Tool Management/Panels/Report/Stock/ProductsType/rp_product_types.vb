...
Public Class rp_product_types
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        For Each Item In lbProductType.SelectedItems
        ...
        dt_main = config.GetDataTable("SELECT tb_products_type.products_type_id ,  products_type_name, SUM( stock_qty * stock_price) as cost " &
                                      "FROM tb_stock_log " &
                                      ...
                                      "AND tb_products_type.products_type_id IN (" & str_in & ") " & str &
                                      "GROUP BY  tb_products_type.products_type_id  " &
                                      "ORDER BY  tb_products_type.products_type_id  DESC ")

        If cbChartType.SelectedItem = "Candle" Then
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_types.rdlc"
        ElseIf cbChartType.SelectedItem = "Pie" Then

            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_types_PIE.rdlc"
        Else
            Me.rvView.LocalReport.ReportEmbeddedResource = "Revel_Tool_Management.rp_product_types_Line.rdlc"
        End If
    ...
    Private Sub cmdSelectAll_Click(sender As Object, e As EventArgs) Handles cmdSelectAll.Click
        For i As Int32 = 0 To lbProductType.Items.Count - 1
            lbProductType.SetSelected(i, True)
        Next
    End Sub

    Private Sub cmdUnselect_Click(sender As Object, e As EventArgs) Handles cmdUnselect.Click
        For i As Int32 = 0 To lbProductType.Items.Count - 1
            lbProductType.SetSelected(i, False)
        Next
    End Sub
    ...
    Sub getProductType()
        ...
        Dim dt As DataTable = config.GetDataTable(
            "SELECT products_type_id, products_type_name FROM tb_products_type "
        )


        lbProductType.DataSource = dt
        lbProductType.DisplayMember = "products_type_name"
        lbProductType.ValueMember = "products_type_id"
